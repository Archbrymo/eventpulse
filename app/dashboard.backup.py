...
# ============================================================
    ...
    if events_df.empty:
        st.info(
            "No events table or event records available."
        )
    else:
        st.dataframe(
            events_df,
